...
```sh
tbox@fedora:~/git/trevorbox/openshift-service-mesh/components/gatekeeper-constraints/prohibited-annotation$ gator test -f k8sprohibitedannotations-prohibit-gateway-injection.yaml -f constrainttemplate-k8sprohibitedannotations.yaml -f expansion.yaml -f deployment.yaml -f namespace.yaml 
