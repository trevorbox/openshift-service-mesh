...
# test connectivity
siege https://bookinfo-istio-ingress.apps.east.sandbox5519.opentlc.com/productpage
```
...
export REMOTE_CLUSTER_URL=https://api.west.sandbox5367.opentlc.com:6443
...
export REMOTE_CLUSTER_NAMESPACE=kiali
export REMOTE_CLUSTER_URL=https://api.east.sandbox5519.opentlc.com:6443
export VIEW_ONLY=false
export EXEC_AUTH_JSON=
./kiali-prepare-remote-cluster.sh
```
...
```sh
curl --cacert out.pem https://api.west.sandbox5367.opentlc.com:6443
oc login --token='MY_TOKEN' https://api.west.sandbox5367.opentlc.com:6443
